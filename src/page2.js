    ...
    return (
      <div className="main-page2">
        <Nav className="navbar2 text-center">
          <div
            className="nav-div nav-div2"
            title="tab-1"
            onClick={handle}
            style={{
              backgroundImage: x1
                ? `linear-gradient(to left, #14469F , #94149f)`
                : ``,
            }}
          >
            ...
            <div className="navbar2-content1-div2">
              <div className="navbar2-content1-div2-kill">
                ...
                <div>
                  <div className="navbar2-content1-div2-kill2">
                    <h2>
                      <a
                        href="https://github.com/15mahmoud/course.git"
                        target="_blank"
              ...
              <div className="navbar2-content1-div2-kill">
                ...
                <div className="navbar2-content1-div2-kill2">
                  <h2>
                    <a
                      href="https://github.com/15mahmoud/ecommerce-api.git"
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ color: "white", textDecoration: "none" }}
                    >
              ...
              <div className="navbar2-content1-div2-kill">
                ...
                <div className="navbar2-content1-div2-kill2">
                  <h2>
                    <a
                      href="https://15mahmoud.github.io/project-3/"
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ color: "white", textDecoration: "none" }}
                    >
            ...
            <div className="navbar2-content1-div2 navbar2-content1-div404">
              <div className="navbar2-content1-div2-kill">
                ...
                <div className="navbar2-content1-div2-kill2">
                  <h2>
                    <a
                      href="https://15mahmoud.github.io/project-1/"
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ color: "white", textDecoration: "none" }}
                    >
              ...
              <div className="navbar2-content1-div2-kill">
                ...
                <div className="navbar2-content1-div2-kill2">
                  <h2>
                    <a
                      href="https://15mahmoud.github.io/project-2/"
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ color: "white", textDecoration: "none" }}
                    >
              ...
              <div className="navbar2-content1-div2-kill">
                ...
                <div className="navbar2-content1-div2-kill2">
                  <h2>
                    <a
                      href="https://todo-list-tawny-kappa-96.vercel.app/"
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ color: "white", textDecoration: "none" }}
                    >
        ...
        <div className="navbar2-content1 navbar2-content1-pg3" ref={z}>
          <h2>My name is Mahmoud Soliman,I am a Full-stack Dev</h2>
        </div>

        <div
          className="navbar2-content1 navbar2-content1-pg2"
          style={{ display: "none" }}
          ref={y}
        >
